...
public class ClosestStationFinder {
    ...
    public StationInformation.Station findClosestStationWithDocks(double userLat, double userLon, StationInformation stationInfo, StationStatus stationStatus) {
        return stationInfo.data.stations.stream()
